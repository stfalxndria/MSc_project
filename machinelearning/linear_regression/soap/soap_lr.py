...
#reading the files
structures = np.load('structures.npy', allow_pickle=True)

ase_structures = np.load('ase_structures.npy', allow_pickle=True)

soap_dscribe = np.load('./descriptor/soap_dscribe.npy',allow_pickle=True)
...
errorscores = errorgraph(y_test, ypred_LR, 'soap', 'linear regression')

soap_lr = soap_lr.to_pickle('soap_lr.pkl')
